  ...
  if (fetchUser) {
    return (
      <div className="lobbies">
        ...
        {joinedLobby && (
          <JoinedLobby lobbyName={lobbyName} setJoined={setJoined} setLobbyName={setLobbyName} setLobbyList={setLobbyList} errorMessage={errorMessage} setErrorMessage={setErrorMessage}></JoinedLobby>
        )
        }
      </div>
    );
